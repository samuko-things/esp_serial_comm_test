...
if __name__ == '__main__':
  motorController.setParam("/timeout", -1, 4000)
  ...
  motorController.setParam("/ppr", 0, 374.25)
  res = motorController.getParam("/ppr", 0)
  print('ppr_0: ', res)
  motorController.setParam("/ppr", 1, 1092.0)
  res = motorController.getParam("/ppr", 1)
  print('ppr_1: ', res)

  print()

  motorController.setParam("/kp", 0, 35.0)
  res = motorController.getParam("/kp", 0)
  print('kp_0: ', res)
  motorController.setParam("/ki", 0, 70.0)
  res = motorController.getParam("/ki", 0)
  print('ki_0: ', res)
  motorController.setParam("/kd", 0, 3.5)
  res = motorController.getParam("/kd", 0)
  print('kd_0: ', res)

  print()

  motorController.setParam("/kp", 1, 80.0)
  res = motorController.getParam("/kp", 1)
  print('kp_1: ', res)
  motorController.setParam("/ki", 1, 160.0)
  res = motorController.getParam("/ki", 1)
  print('ki_1: ', res)
  motorController.setParam("/kd", 1, 8.0)
  ...
  if pidMode == 1:
    res = motorController.writeSpeed(0, 6.284)
    print(res)
    time.sleep(2.0)
  ...
  if pidMode == 0:
    res = motorController.writePWM(0, 0)
    print(res)
