...
class PidSetupFrame(tb.Frame):
  ...
  def setKpFunc(self, kp_val_str):
    try:
      if kp_val_str:
        isSuccessful = g.motorController.setParam("/kp", self.motorNo, float(kp_val_str))
        val = g.motorController.getParam("/kp", self.motorNo)
  ...
  def setKiFunc(self, ki_val_str):
    try:
      if ki_val_str:
        isSuccessful = g.motorController.setParam("/ki", self.motorNo, float(ki_val_str))
        val = g.motorController.getParam("/ki", self.motorNo)
  ...
  def setKdFunc(self, kd_val_str):
    try:
      if kd_val_str:
        isSuccessful = g.motorController.setParam("/kd", self.motorNo, float(kd_val_str))
        val = g.motorController.getParam("/kd", self.motorNo)
  ...
  def setCfFunc(self, cf_val_str):
    try:
      if cf_val_str:
        isSuccessful = g.motorController.setParam("/cut-freq", self.motorNo, float(cf_val_str))
        val = g.motorController.getParam("/cut-freq", self.motorNo)
